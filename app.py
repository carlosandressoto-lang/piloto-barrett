...
if df is not None:
    ...
    with cnb1:
        ...
        if es_confa or es_gerencia:
            ...
            fig_nb.add_trace(go.Scatter(mode='markers+text', text=[f"({d.DES}, {round(d.IND_POT,1)}%)"], textposition="top center", textfont=dict(color="white", size=11), marker=dict(size=14, color='red', symbol='diamond', line=dict(width=2, color='white'))))
