...
if df is not None:
    ...
    with r3: st.plotly_chart(dibujar_reloj_fijo([d.ORG_L1, d.ORG_L2, d.ORG_L3, d.ORG_L4, d.ORG_L5, d.ORG_L6, d.ORG_L7], "Cultura") if 'dibujar_reloj_fijo' in globals() else dibujar_reloj_limpio([d.ORG_L1, d.ORG_L2, d.ORG_L3, d.ORG_L4, d.ORG_L5, d.ORG_L6, d.ORG_L7], "Cultura"), use_container_width=True)
