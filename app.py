        ...
        def generar_pdf_final(tipo="GH"):
            ...
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                filas = [
                    ...
                    ["L4: Facilitador (Transformación)", "Oportunidad para delegar con mayor confianza, abrirse a probar ideas nuevas, adaptarse mejor a los cambios y promover activamente el bienestar y el tiempo personal del equipo.", "Se adapta a prioridades y delega a veces, pero puede dar más espacio al aprendizaje desde el error, a la innovación continua y al cuidado del equilibrio vida-trabajo.", "Frecuentemente delega sin microgestionar, fomenta el aprendizaje a partir del error, se adapta rápido a los cambios y promueve prácticas que protegen la vida personal.", "Empoderador nato que fomenta la innovación con total confianza, se adapta con gran agilidad frente al cambio y garantiza un equilibrio excepcional entre la vida y el trabajo."],
                    ["L3: Organizador (Autoestima)", "Requiere definir metas más claras y hacer un mejor seguimiento, además de buscar la simplificación del trabajo compartiendo información y eliminando trámites innecesarios.", "Logra cumplir acuerdos y definir metas, pero la agilidad del equipo se ve limitada por un seguimiento intermitente, falta de información fluida o exceso de burocracia.", "Frecuentemente establece metas y métricas claras, cumple los acuerdos con buen seguimiento, comparte información oportuna y busca formas sencillas de optimizar el trabajo.", "Referente en eficiencia que siempre asegura total claridad en las metas, optimiza procesos eliminando cualquier trámite innecesario y garantiza un flujo de información impecable."],
