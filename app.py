        ...
        def generar_pdf_final(tipo="GH"):
            ...
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                if tipo == "COLABORADOR":
                    ...
                    filas = [
                        ["L7: Visionario (Servicio)", "Visión estratégica compartida de forma constante y conectada con el trabajo diario y el propósito de Confa. Refleja un liderazgo basado en la humildad y el servicio, la toma de decisiones enfocada en el bien común por encima de los intereses del área y la habilidad para inspirar al equipo a superar las expectativas."],
                        ["L6: Mentor (Hacer la Diferencia)", "Disposición para dedicar tiempo a la enseñanza y entregar retroalimentación útil. Considera la integración y colaboración ágil con otras áreas o aliados, la promoción de un entorno plenamente inclusivo y el análisis del impacto social y ambiental al momento de decidir."],
                        ["L5: Integrador (Cohesión Interna)", "Coherencia al dar ejemplo y cumplir lo que se promete, junto con la habilidad de explicar el propósito de las tareas y proyectos. Incluye la toma de decisiones basada en los valores de Confa, el fomento de un buen ambiente de trabajo y la capacidad de generar orgullo en el equipo."],
                        ["L4: Facilitador (Transformación)", "Habilidad para delegar tareas con confianza sin caer en la microgestión. Analiza la apertura para aprender de los errores, probar nuevas ideas, adaptarse rápidamente frente a cambios de prioridades y promover prácticas orientadas a cuidar la vida personal del equipo."],
                        ["L3: Organizador (Autoestima)", "Definición de metas claras con sus respectivas métricas y el cumplimiento o seguimiento de acuerdos. Contempla también la colaboración al compartir información, la búsqueda de alternativas sencillas para trabajar mejor y la capacidad de evitar trámites burocráticos que frenan la operación."],
                        ["L2: Relaciones (Relación)", "Calidad de la escucha activa y el trato respetuoso hacia todas las personas sin importar su cargo. Contempla la claridad y oportunidad al hablar sobre temas difíciles, además de la entrega de reconocimiento por el buen trabajo tanto en público como en privado."],
                        ["L1: Crisis (Supervivencia)", "Capacidad para mantener la calma ante problemas, cuidar responsablemente los recursos de trabajo y anticipar riesgos antes de tomar decisiones. Se observa también la atención a la seguridad y bienestar del equipo, así como el nivel de confianza al evitar la revisión innecesaria de todas las tareas."]
                    ]
                ...
                # --- ÚLTIMA PÁGINA: ANÁLISIS EJECUTIVO ---
                pdf.add_page()
